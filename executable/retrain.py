...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
    ...
    Returns:
      ...
      Format:
      image_lists: {'cars motors': {'dir': 'Cars & Motors', 'training':
      ['nissan-livina.jpg', 'toyota-corolla-2008.jpg', 'ford-focus-2014.jpg',..}
    """
    ...
    for sub_dir in sub_dirs:
        ...
        for extension in extensions:
            ...
            file_list.extend(gfile.Glob(file_glob))  # list files matching pattern
        if not file_list:
    ...
    if FLAGS.print_misclassified_test_images:
        ...
        for i, test_filename in enumerate(test_filenames):
            if predictions[i] != test_ground_truth[i].argmax():
                print('{:<60s}  {:<30s} {}'.
                      format(os.path.basename(test_filename),
                             list(image_lists.keys())[test_ground_truth[i].argmax()],
